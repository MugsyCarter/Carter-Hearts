  ...
  Deck.dealCards = function(){
    ...
    function successHandler(data){
      ...
      for (var i =0; i < Deck.compDecks[0].length; i++){
        $('.compHand1').append('<div class="comp1Card" id="'+Deck.compDecks[0][i].code+'" data-suit="'+Deck.compDecks[0][i].suit+'" data-value="'+Deck.compDecks[0][i].value+'"><img src="'+Deck.compDecks[0][i].image+'"</div>');
      }
      for (var i =0; i < Deck.compDecks[1].length; i++){
        $('.compHand2').append('<div class="comp2Card" id="'+Deck.compDecks[1][i].code+'" data-suit="'+Deck.compDecks[1].suit+'" data-value="'+Deck.compDecks[1][i].value+'"><img src="'+Deck.compDecks[1][i].image+'"</div>');
      }
      for (var i =0; i < Deck.compDecks[2].length; i++){
        $('.compHand3').append('<div class="comp3Card" id="'+Deck.compDecks[2][i].code+'" data-suit="'+Deck.compDecks[2].suit+'" data-value="'+Deck.compDecks[2][i].value+'"><img src="'+Deck.compDecks[2][i].image+'"</div>');
      }
